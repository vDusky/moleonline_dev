...
import { Geometry, GeometryUtils } from 'molstar/lib/mol-geo/geometry/geometry';
...
import { getNextMaterialId, createRenderObject, GraphicsRenderObject } from 'molstar/lib/mol-gl/render-object';
import { Theme } from 'molstar/lib/mol-theme/theme';
import { LocationIterator } from 'molstar/lib/mol-geo/util/location-iterator';
import { LocationCallback, VisualUpdateState } from 'molstar/lib/mol-repr/util';
import { createMarkers } from 'molstar/lib/mol-geo/geometry/marker-data';
import { MarkerAction, MarkerActions } from 'molstar/lib/mol-util/marker-action';
import { ValueCell } from 'molstar/lib/mol-util';
import { createColors } from 'molstar/lib/mol-geo/geometry/color-data';
import { createSizes, SizeData } from 'molstar/lib/mol-geo/geometry/size-data';
import { Loci, isEveryLoci, EmptyLoci } from 'molstar/lib/mol-model/loci';
import { Interval, OrderedSet } from 'molstar/lib/mol-data/int';
import { PickingId } from 'molstar/lib/mol-geo/geometry/picking';
import { Visual } from 'molstar/lib/mol-repr/visual';
import { RuntimeContext, Task } from 'molstar/lib/mol-task';
import { ParamDefinition as PD } from 'molstar/lib/mol-util/param-definition';
import { isDebugMode } from 'molstar/lib/mol-util/debug';
